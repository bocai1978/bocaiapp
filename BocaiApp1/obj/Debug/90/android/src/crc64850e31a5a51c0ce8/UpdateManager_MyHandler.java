...
/** @hide */
	...
	public UpdateManager_MyHandler (android.os.Handler.Callback p0)
	{
		super (p0);
		if (getClass () == UpdateManager_MyHandler.class)
			mono.android.TypeManager.Activate ("Com.Bocaihua.APP.UpdateManager+MyHandler, com.bocaihua.app.smartAssistant", "Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0 });
	}
	...
	public UpdateManager_MyHandler (android.os.Looper p0, android.os.Handler.Callback p1)
	{
		super (p0, p1);
		if (getClass () == UpdateManager_MyHandler.class)
			mono.android.TypeManager.Activate ("Com.Bocaihua.APP.UpdateManager+MyHandler, com.bocaihua.app.smartAssistant", "Android.OS.Looper, Mono.Android:Android.OS.Handler+ICallback, Mono.Android", this, new java.lang.Object[] { p0, p1 });
	}
